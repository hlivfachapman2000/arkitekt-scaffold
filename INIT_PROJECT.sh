...
# OpenAI-compatible embeddings endpoint (must be explicit — most dotenv loaders do NOT expand variables)
LOCAL_EMBEDDING_URL=http://your-ollama-host:11434/v1/embeddings

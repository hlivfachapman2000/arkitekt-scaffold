...
import { DocumentTextIcon, CalculatorIcon, PuzzlePieceIcon, ClipboardDocumentCheckIcon, NewspaperIcon } from '@heroicons/react';
import { CursorArrowRaysIcon, ChartBarIcon, SparklesIcon } from '@heroicons/react';
